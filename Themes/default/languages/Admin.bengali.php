...
$txt['settings_saved'] = 'সেটিংস সফলভাবে সংরক্ষণ করা হয়েছে';
$txt['settings_not_saved'] = 'আপনার করা পরিবর্তন গুলি সংরক্ষণ হয়নি কারণ:%1$s';

$txt['admin_boards'] = 'বোর্ড এবং বিভাগ';
$txt['admin_users'] = 'সদস্যগন';
$txt['admin_newsletters'] = 'নিউসলেটার';
$txt['admin_edit_news'] = 'খবর';
$txt['admin_groups'] = 'সদস্য গোষ্ঠী';
$txt['admin_members'] = 'সদস্যদের পরিচালনা';
$txt['admin_members_list'] = 'নীচে আপনার ফোরামে বর্তমানে নিবন্ধিত সমস্ত সদস্যদের একটি তালিকা রয়েছে.';
$txt['admin_next'] = 'পরবর্তী';
$txt['admin_censored_words'] = 'সেন্সর করা শব্দ';
$txt['admin_censored_where'] = 'বাম দিকে সেন্সর করা শব্দ রাখুন এবং ডানদিকে কি পরিবর্তন করতে হবে.';
$txt['admin_censored_desc'] = 'ফোরামের সর্বজনীন প্রকৃতির কারণে এমন কিছু শব্দ থাকতে পারে যা আপনি আপনার ফোরামের ব্যবহারকারীদের দ্বারা পোস্ট করা নিষিদ্ধ করতে চান। আপনি নীচের যে কোনও শব্দ লিখতে পারেন যেগুলি আপনি যখনই কোনও সদস্য ব্যবহার করতে চান তখন সেন্সর হতে চান৷<br>সেন্সর থেকে সেই শব্দটি সরাতে একটি বাক্স সাফ করুন.';
$txt['admin_reserved_names'] = 'সংরক্ষিত নাম';
$txt['admin_modifications'] = 'সেটিংস পরিবর্তন';
$txt['admin_server_settings'] = 'সার্ভার সেটিংস';
$txt['admin_reserved_set'] = 'সংরক্ষিত নাম সেট করুন';
$txt['admin_reserved_line'] = 'প্রতি লাইনে একটি সংরক্ষিত শব্দ.';
$txt['admin_basic_settings'] = 'এই পাতাটি আপনাকে আপনার ফোরামের মৌলিক সেটিংস পরিবর্তন করতে দেয়. এই সেটিংস গুলির সাথে খুব সতর্কতা অবলম্বন করুন, কারণ সেগুলি ফোরাম টিকে অকার্যকর করে তুলতে পারে.';
$txt['admin_maintain'] = 'রক্ষনাবেক্ষন মোড চালু করুন';
$txt['admin_title'] = 'ফোরাম শিরোনাম';
$txt['cookie_name'] = 'কুকির নাম';
$txt['admin_webmaster_email'] = 'ওয়েবমাস্টার ইমেইলের ঠিকানা';
$txt['cachedir'] = 'কেচ ডিরেক্টরি';
$txt['admin_news'] = 'খবর চালু করুন';
$txt['admin_manage_members'] = 'সদস্যগন';
$txt['admin_main'] = 'আসল';
$txt['admin_config'] = 'কনফিগুরেশন';
$txt['admin_version_check'] = 'বিস্তারিত সংরক্ষণ চেক';
$txt['admin_smffile'] = 'SMF ফাইল';
$txt['admin_smfpackage'] = 'SMF প্যাকেজ';
$txt['admin_logoff'] = 'প্রশাসন সেশন শেষ করুন';
$txt['admin_maintenance'] = 'রক্ষনাবেক্ষন';
$txt['admin_credits'] = 'ক্রেডিটস';
$txt['admin_agreement'] = 'নতুন সদস্যদের নিবন্ধন চুক্তি গ্রহণ করতে হবে';
$txt['admin_agreement_minor_edit'] = 'এটি একটি ছোটোখাটো সম্পাদনা';
$txt['reset_agreement_desc'] = 'এটি সমস্ত সদস্যকে ফোরাম ব্যবহার চালিয়ে যাওয়ার জন্য নিবন্ধন চুক্তিটি পুনরায় পড়তে এবং গ্রহণ করতে বাধ্য করবে.';
$txt['admin_privacy_policy'] = 'নতুন সদস্যদের গোপনীয়তা নীতি গ্রহণ করতে হবে';
$txt['reset_privacy_policy_desc'] = 'এটি সমস্ত সদস্যকে ফোরাম ব্যবহার চালিয়ে যাওয়ার জন্য নিবন্ধন চুক্তিটি পুনরায় পড়তে এবং গ্রহণ করতে বাধ্য করবে.';
$txt['admin_agreement_info'] = 'শেষ আপডেটেড:%1$s.';
